...
<div class="row mt-4">
    <div class="col-12">
        <h4>The 25 most recent expenses for {{ $child_details['short_name'] }} in {{ $active_year }} <small> - <a href="{{ $child_details['uri'] . '/expenses?year=' . $active_year . '#expenses-table' }}">(View all {{ $active_year }} expenses)</a></small></h4>
