...
<li class="nav-item @if ($item['icon'] !== null)icon @endif">
    <a class="nav-link @if ($item['icon'] !== null)icon @endif @if ($item['uri'] === $active) active @endif" href="{{ $item['uri'] }}" title="{{ $item['title'] }}">
